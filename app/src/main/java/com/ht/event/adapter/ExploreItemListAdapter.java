...
public class ExploreItemListAdapter extends RecyclerView.Adapter<ExploreItemListAdapter.ViewHolderExploreList> {
    ...
    public ExploreItemListAdapter(Context context, ArrayList<Event> eventitem) {
